      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="/ekapp/default.jsp">Home <span class="sr-only">(current)</span></a>
          </li>
           <li class="nav-item">
            <a class="nav-link" href="/ekapp/profile/profile.jsp">Profile</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/ekapp/Dashboard.jsp?p=Election">Election</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/ekapp/Dashboard.jsp?p=Users">Users</a>
          </li>
        </ul>
