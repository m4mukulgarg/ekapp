			...
			<div class="w3l-banner-grids">
				<div class="col-md-8 w3ls-banner-right">
					...
					<div class="banner-right-info">
						<h2><% out.write(u.getQuote()); %></h2>
						<p><% out.write(u.getAbout()); %></p>
					</div>
				...
				<div class="col-md-4 w3ls-banner-left">
					...
					<% if (u.getCategory()==UserCategory.CANDIDATE){ %>
						<p><%out.write(u.getPostApplied().getPostString()); %></p>
					<% } else{ %>
					<p><%out.write(u.getCategory().getCategoryString()); }%></p>
					</div>
					<div class="w3ls-banner-left-info">
						<h4>Name</h4>
						<p><%out.write(u.getName()); %></p>
					</div>
					<div class="w3ls-banner-left-info">
						<h4>Gender</h4>
						<p><%out.write(u.getGender().toString()); %></p>
					</div>
					<div class="w3ls-banner-left-info">
						<h4>Address</h4>
						<p><%out.write(u.getAddress());%></p>
					</div>
					<div class="w3ls-banner-left-info">
						<h4>Email Address</h4>
						<p><a href="mailto:<%out.write(u.getEmail()); %>"><%out.write(u.getEmail()); %></a></p>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
