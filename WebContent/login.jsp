...
<jsp:include page="navbar.jsp"/>
				...
				if(email != null){
					...
					if(user.equalsPassword(pass)){
						if(user.isApproved()){
							...
							out.write("<p class=\"form-signin\">Your account is under process! Please wait till your account is approved by an admin.</p>");
						}
					}
					else{
	...
	%>
      ...
      <form class="form-signin" action="login.jsp" method="post">
        ...
        <input type="email" id="inputUserId" name = "email" class="form-control" placeholder="User Id" required autofocus>
        <label for="inputPassword" class="sr-only">Password</label>
        <input type="password" id="inputPassword" name="pass" class="form-control" placeholder="Password" required>
        <div class="checkbox">
          <label>
            <input type="checkbox" name="saveCookies" value="remember-me"> Remember me
          </label>
        </div>
